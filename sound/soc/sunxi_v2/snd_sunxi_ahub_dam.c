...
struct sunxi_ahub_mem_info sunxi_mem = {
	.res = &sunxi_res,
};
static struct sunxi_ahub_clk_info sunxi_clk;
...
{
	struct sunxi_ahub_clk_info *clk_info = &sunxi_clk;
...
int snd_soc_sunxi_ahub_mem_get(struct sunxi_ahub_mem_info *mem_info)
{
	...
	mem_info->regmap = sunxi_mem.regmap;
	mem_info->res = sunxi_mem.res;
...
int snd_soc_sunxi_ahub_clk_get(struct sunxi_ahub_clk_info *clk_info)
{
	...
	clk_info->clk_pll = sunxi_clk.clk_pll;
	clk_info->clk_pllx4 = sunxi_clk.clk_pllx4;
	clk_info->clk_module = sunxi_clk.clk_module;
...
{
	struct sunxi_ahub_mem_info *mem_info = &sunxi_mem;
	struct sunxi_ahub_clk_info *clk_info = &sunxi_clk;
