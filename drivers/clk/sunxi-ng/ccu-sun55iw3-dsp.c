...
static const char * const ahb_parents[] = { "r-ahb", "pll-audio1-div2", "pll-audio1-div5" };

static SUNXI_CCU_M_WITH_MUX(dsp_ahb_clk, "dsp_ahb", ahb_parents, 0x0024,
			     0, 5,
			     24, 3,
			     0);

static SUNXI_CCU_M(apb_clk, "apb",
		   "dsp_ahb", 0x0028,
		   0, 5, 0);
...
static const char * const dsp_timer_parents[] = { "dcxo24M", "rtc32k", "rc-16m", "dsp_ahb" };
...
static struct ccu_reset_map sun55iw3_dsp_ccu_resets[] = {
 [RST_BUS_I2S3]			= { 0x0040, BIT(19) },
 [RST_BUS_I2S2]			= { 0x0040, BIT(18) },
 [RST_BUS_I2S1]			= { 0x0040, BIT(17) },
 [RST_BUS_I2S0]			= { 0x0040, BIT(16) },
 [RST_BUS_SPDIF]		= { 0x004c, BIT(16) },
 [RST_BUS_DMIC]			= { 0x0054, BIT(16) },
 [RST_BUS_AUDIO_CODEC]		= { 0x0060, BIT(16) },
 [RST_BUS_DSP_MSG]		= { 0x0068, BIT(16) },
 [RST_BUS_DSP_CFG]		= { 0x006c, BIT(16) },
 [RST_BUS_NPU]			= { 0x0070, BIT(16) },
 ...
 [RST_BUS_RV_CORE]		= { 0x0124, BIT(18) },
 [RST_BUS_RV_APB_DB]		= { 0x0124, BIT(17) },
 [RST_BUS_RV_CFG]		= { 0x0124, BIT(16) },
 [RST_BUS_RV_MSG]		= { 0x0128, BIT(16) },
...
static struct clk_hw_onecell_data sun55iw3_dsp_hw_clks = {
	.hws    = {
		...
		[CLK_PLL_AUDIO_OUT]		= &pll_audio_out_clk.common.hw,
		[CLK_DSP_DSP]			= &dsp_dsp_clk.common.hw,
		[CLK_DSP_AHB]			= &dsp_ahb_clk.common.hw,
		...
		[CLK_I2S0_BGR]			= &i2s0_bgr_clk.common.hw,
		[CLK_I2S1_BGR]			= &i2s1_bgr_clk.common.hw,
		[CLK_I2S2_BGR]			= &i2s2_bgr_clk.common.hw,
		[CLK_I2S3_BGR]			= &i2s3_bgr_clk.common.hw,
		...
		[CLK_NPU_ACLK]			= &npu_aclk.common.hw,
		[CLK_NPU_HCLK]			= &npu_hclk.common.hw,
		[CLK_DSP_NPU]			= &dsp_npu_clk.common.hw,
		...
		[CLK_DSP_DMA]			= &dsp_dma_clk.common.hw,
		[CLK_TZMA0]			= &tzma0_clk.common.hw,
		[CLK_TZMA1]			= &tzma1_clk.common.hw,
		[CLK_PUBSRAM]			= &pubsram_clk.common.hw,
		[CLK_DSP_MBUS]			= &dsp_mclk.common.hw,
		[CLK_DMA_MBUS]			= &dma_mclk.common.hw,
		...
		[CLK_PWM_BGR]			= &pwm_bgr_clk.common.hw,
		[CLK_AHB_AUTO]			= &ahb_auto_clk.common.hw,
	},
	.num = CLK_DSP_NUMBER,
};
/* ccu_def_end */
